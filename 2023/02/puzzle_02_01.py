         ...
         itertools.chain.from_iterable( 
            [itertools.product((k, ), v) for k, v in pos_dict.items()])):
                ...
                if key == "red":
                    ...
                    cache_game_cubes[key] = red_cubes
                ...
                if key == "green":
                    green_cubes = green_cubes + int(amount[1])
                    cache_game_cubes[key] = green_cubes
                ...
                if key == "blue":
                    blue_cubes = blue_cubes + int(amount[1])
                    cache_game_cubes[key] = blue_cubes                     
